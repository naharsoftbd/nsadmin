...
export default function Edit(props){
	...
	const { data, setData, post, processing, errors, reset, progress } = useForm({
        ...
        content_dir:props.content.content_dir,
        ...
        mobile_thumbnail: props.content.mobile_thumbnail,
        web_logo: props.content.web_logo,
        web_thumbnail: props.content.web_thumbnail,
        stb_logo: props.content.stb_logo,
        stb_thumbnail: props.content.stb_thumbnail,
        category: props?.content?.category_id,
        category_name: props?.content?.category_name,
        sub_category: props?.content?.sub_category_id,
        sub_category_name: props?.content?.sub_category_name,
        is_premium: props?.content?.is_premium,
        is_purchased: props?.content?.is_purchased,
        is_trailer_available: props?.content?.is_purchased,
        trailer_url: props?.content?.trailer_url,
        age_restriction: props?.content?.age_restriction,
        orientation: props?.content?.orientation,
        content_file_name: props?.content?.content_file_name,
        content_aes_128_hls_url: props?.content?.content_aes_128_hls_url,
        content_drm_dash_url: props?.content?.content_drm_dash_url,
        content_drm_hls_url: props?.content?.content_drm_hls_url,
        share_url: props?.content?.share_url,
        content_expire_time: props?.content?.content_expire_time,
        content_publish_time: props?.content?.content_publish_time,
        role:1
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('contents.update',[props.content.id]));
    };
	...
	return (
        ...
        >
            ...
            <form className="w-2/3 mx-auto pb-4" onSubmit={submit} enctype="multipart/form-data">
                ...
                <div className="mt-4">
                    <Label forInput="content_dir" value="Content Dir" />
                    <Input
                        type="text"
                        name="content_dir"
                        value={data.content_dir}
                        className="mt-1 block w-full bg-slate-50"
                        autoComplete="content_dir"
                        isFocused={true}
                        handleChange={onHandleChange}
                        required
                        readOnly={true}
                ...
                <fieldset className="border border-solid border-gray-300 p-3 mt-4">
                 ...
                 <div className="mt-0">
                    ...
                    { data.feature_banner instanceof File ? <img className="mt-1" width="500" src={URL.createObjectURL(data.feature_banner)} />:<img className="mt-1" width="500" src={props.ziggy.url+'/storage/'+data.feature_banner} /> }
                ...
                <div className="col-span-1 mt-4">
                    ...
                    { data.mobile_logo instanceof File ? <img className="mt-1" width="200" src={URL.createObjectURL(data.mobile_logo)} />:<img className="mt-1" width="200" src={props.ziggy.url+'/storage/'+data.mobile_logo} /> }
                ...
                <div className="col-span-1 mt-4">
                    ...
                    { data.mobile_thumbnail instanceof File ? <img className="mt-1" width="200" src={URL.createObjectURL(data.mobile_thumbnail)} />:<img className="mt-1" width="200" src={props.ziggy.url+'/storage/'+data.mobile_thumbnail} /> }
                ...
                <div className="col-span-1 mt-4">
                    ...
                    { data.web_logo instanceof File ? <img className="mt-1" width="200" src={URL.createObjectURL(data.web_logo)} />:<img className="mt-1" width="200" src={props.ziggy.url+'/storage/'+data.web_logo} /> }
                ...
                <div className="col-span-1 mt-4">
                    ...
                    { data.web_thumbnail instanceof File ? <img className="mt-1" width="300" src={URL.createObjectURL(data.web_thumbnail)} />:<img className="mt-1" width="300" src={props.ziggy.url+'/storage/'+data.web_thumbnail} /> }
                ...
                <div className="col-span-1 mt-4">
                    ...
                    { data.stb_logo instanceof File ? <img className="mt-1" width="300" src={URL.createObjectURL(data.web_thumbnail)} />:<img className="mt-1" width="300" src={props.ziggy.url+'/storage/'+data.stb_logo} /> }
                ...
                <div className="col-span-1 mt-4">
                    ...
                    { data.stb_thumbnail instanceof File ? <img className="mt-1" width="300" src={URL.createObjectURL(data.stb_thumbnail)} />:<img className="mt-1" width="300" src={props.ziggy.url+'/storage/'+data.stb_thumbnail} /> }
